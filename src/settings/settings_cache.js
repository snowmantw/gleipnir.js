 ...
 **/
(function(exports) {
  var GleipnirSettingsCache = function() {
    this.cache = {};
    this.handleSettings = this.handleSettings.bind(this);
  };
  GleipnirSettingsCache.prototype.get = function(entry) {
    if (this.cache[entry]) {
  ...
  GleipnirSettingsCache.prototype.set = function(entry, value) {
    var resolve, reject;
    var promise = new Promise((rev, rej) => {
      resolve = rev;
      reject = rej;
